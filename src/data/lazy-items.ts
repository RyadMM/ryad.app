...
export const lazyItems: LazyItem[] = [
  // === ESSENTIAL ===
  {
    ...
    adhdBenefit: "Élimine la friction « ouvrir placard → trouver cintre → accrocher ». Un geste, c'est fini.",
    effortScore: 1,
    essential: true,
  ...
  },
  {
    ...
    adhdBenefit: "Le couvercle est une barrière mentale. Sans couvercle = zéro friction pour ranger.",
    effortScore: 2,
    essential: true,
  ...
  },
  {
    ...
    adhdBenefit: "La visibilité totale élimine le « hors de vue, hors de l'esprit ». Tu sais exactement ce que tu possèdes.",
    effortScore: 2,
    essential: true,
  ...
  },
  {
    ...
    adhdBenefit: "Place le stockage au point exact de décision. Pas besoin de se déplacer pour ranger.",
    effortScore: 1,
    essential: true,
  ...
  },
  {
    ...
    adhdBenefit: "Le couvercle ajoute une étape. Sans couvercle = tu lances et tu continues ta vie.",
    effortScore: 1,
    essential: true,
  ...
  },
  {
    ...
    adhdBenefit: "Point de dépôt unique. Tes clés sont toujours au même endroit, même les jours de brain fog.",
    effortScore: 1,
    essential: true,
  ...
  // === ADDITIONS (RESEARCH-BACKED) ===
  {
    ...
    adhdBenefit: "Réduit la friction de fouiller derrière les choses. La visibilité = l'utilisation.",
    effortScore: 2,
    essential: false,
  ...
  },
  {
    ...
    adhdBenefit: "Le courrier horizontal devient une pile impossible. Le vertical reste gérable.",
    effortScore: 2,
    essential: false,
  ...
  },
  {
    ...
    adhdBenefit: "La transparence élimine le mystère. Tu sais exactement où sont tes affaires sans ouvrir.",
    effortScore: 2,
    essential: false,
  ...
  },
  {
    ...
    adhdBenefit: "Le stockage vient à toi, pas l'inverse. Idéal pour les objets utilisés partout.",
    effortScore: 2,
    essential: false,
  ...
  },
  {
    ...
    adhdBenefit: "Utilise l'espace qui existe déjà. Pas besoin de meuble supplémentaire.",
    effortScore: 2,
    essential: false,
  ...
  },
  {
    ...
    adhdBenefit: "Zéro perçage, zéro outil. Tu installes, tu utilises. Barrière à l'entrée éliminée.",
    effortScore: 2,
    essential: false,
