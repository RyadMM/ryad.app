 ...
 * ============================================
 * Centralized slide definitions.
 * Modify this file to add/edit slides.
 */
...
export const slides = [
    {
        ...
        content: `
            <div class="max-w-4xl text-center">
                ...
                <h1 class="text-5xl md:text-7xl font-bold mb-6 animate-in delay-1" style="background: linear-gradient(135deg, #fff 0%, #a1a1aa 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                    L'Art du Contexte
                </h1>
                    ...
                    <div>
                        ...
                        <div class="card mt-6 animate-in delay-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <button onclick="addContext(1, 5)" class="px-3 py-1.5 text-sm bg-zinc-800 hover:bg-zinc-700 rounded-lg transition">
                                    + Petit fichier (5%)
                                </button>
                                <button onclick="addContext(1, 30)" class="px-3 py-1.5 text-sm bg-zinc-800 hover:bg-zinc-700 rounded-lg transition">
                                    + Gros module (30%)
                                </button>
                                <button onclick="addContext(2, 15)" class="px-3 py-1.5 text-sm bg-zinc-800 hover:bg-zinc-700 rounded-lg transition">
                                    + Chat history (15%)
                                </button>
                                <button onclick="resetContext()" class="px-3 py-1.5 text-sm bg-red-900/30 hover:bg-red-900/50 text-red-400 rounded-lg transition">
                                    Reset
                                </button>
                            </div>
                        </div>
            ...
            <div class="max-w-6xl w-full">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="space-y-4 animate-in delay-1">
                        <div class="card scenario-card selected" id="scenarioClean" onclick="selectScenario('clean')">
                        ...
                        <div class="card scenario-card" id="scenarioNoise" onclick="selectScenario('noise')">
        ...
        content: `
            <div class="max-w-5xl w-full">
                ...
                <div class="grid md:grid-cols-4 gap-4 animate-in delay-3">
                    ...
                    <div class="text-center">
                        <div class="lego-brick mb-3" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
    ...
    },
    {
        ...
        content: `
            <div class="max-w-4xl text-center">
                <h2 class="text-4xl md:text-5xl font-bold mb-8 animate-in" style="background: linear-gradient(135deg, #fff 0%, #a1a1aa 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
...
export function renderSlides() {
    ...
    slides.forEach((slide, index) => {
        ...
        slideEl.innerHTML = `<div class="slide-content">${slide.content}</div>`;
